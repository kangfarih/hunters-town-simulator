          ...
          <div className="w-full max-w-lg bg-slate-900 border border-amber-500/40 rounded-2xl p-6 shadow-2xl shadow-black/80 text-slate-200">
            ...
            <div className="py-4 space-y-3 text-xs leading-relaxed text-slate-300">
              <div className="p-2.5 rounded-xl bg-slate-800/80 border border-slate-700/60">
                ...
                Heroes auto-summon at the portal every 30s (up to the town cap: 4 + 2 per Sanctuary Hall level). New arrivals register at Sanctuary Hall — funding it raises the cap and the town tax rate. They march out through the region gates (palisade walls funnel every trip through guarded chokepoints), slay monsters, gain EXP, and collect valuable trophies. Overleveled kills earn diminished spoils, worthless beyond +2 levels — hunt at grade. Crowded or outmatched solo hunters muster at the town plaza (🔍 Looking for Party) into level-matched field parties of up to 5 (👥, leader ♛): parties pick prey that pays EXP to the most members so the whole group levels together, members follow the leader's target, pool danger assessment, and split boosted EXP/gold (+15%/+10% per extra member) with rotating loot — nearby members steady the fallen instead of a clinic trip — parties dissolve on entering town or loading a save. Hunters hold the field until HP drops below 20%, bags fill, or they outgrow the zone. Every town arrival chains all errands (tavern, cauldron, forge, academy, clinic) before marching back out. Five dark reserved lands border the realm (north + west) for future expansion. Clerics (⚕️) mend hurt allies (T1 single-target), radiate an aura HoT when the party clusters hurt (T2), and holy-burst the whole party (T3), Bards (🎵) sing Encore +20% ATK and Golden Finale gold fever, making parties preferable for hard prey.
              </div>
