...
export const MONSTER_ARCHETYPES: Record<MonsterType, MonsterArchetype> = {
  ...
  // Region bosses (one per field zone, top of its pay band): forest L5,
  // crypt L10, volcano L15 (lich). Bosses always pay full rewards
  // regardless of level gap, so capped hunters still earn gold/drops.
  boss_thorn: {
    type: 'boss_thorn',
    name: 'Ancient Thornmother',
    level: 5,
    hp: 7000,
    atk: 42,
    def: 10,
